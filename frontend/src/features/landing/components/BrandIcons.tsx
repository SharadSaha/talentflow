...
/**
 * Minimal brand glyphs for social links. Lucide omits trademarked brand icons,
 * so these are provided as inline SVGs using `currentColor` (no hardcoded
 * colours) to stay consistent with the design system.
 */
